<template>
  <div>
    ...
    <div class="scrollable-column" v-motion-slide-right>
      ...
      <div class="meeting-card" v-for="meeting in sortedUpcomingMeetings" :key="meeting.id">
...
import { formatTime, formatDate, getAdvisorFirstName, getCookie } from '../../utils/utils'
